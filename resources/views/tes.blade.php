        ...
        <div class="container">
            <div class="product-detail-content">
                <div class="product-images">
                    <img src="{{ asset('img/' . $product->image) }}" alt="{{ $product->name }}" class="main-image">
                ...
                <div class="product-info">
                    ...
                    <div class="product-details">
                        ...
                        <ul>
                            ...
                            <li>Jenis Pakaian: {{ $product->jenis_pakaian }}</li>
                            <li>Nama Brand: {{ $product->nama_brand }}</li>
                            <li>Code Brand: {{ $product->code_brand }}</li>
                        </ul>
                    </div>
                    <form action="{{ route('addToCart') }}" method="POST">
                        ...
                        <div class="quantity-selection">
                            ...
                            <div class="quantity">
                                ...
                                <span>Stock : {{ $product->stock }} tersisa</span>
